...
sealed class ProductsScreenEvent {
    ...
    data class OnShowCopyProductsScreen(val productUids: String) : ProductsScreenEvent()

    data class OnShowMoveProductsScreen(val productUids: String) : ProductsScreenEvent()
