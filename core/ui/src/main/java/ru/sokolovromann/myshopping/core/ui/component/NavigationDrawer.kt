...
@Composable
fun isModalNavigationDrawer(): Boolean {
    val windowSize = getWindowSize()
    val widthSize = windowSize.widthSizeClass
    val heightSize = windowSize.heightSizeClass
    return widthSize == WindowWidthSizeClass.Compact ||
            widthSize == WindowWidthSizeClass.Medium ||
            heightSize == WindowHeightSizeClass.Compact
}

@Composable
fun isCloseableNavigationDrawer() = getWindowSize().widthSizeClass != WindowWidthSizeClass.Expanded

@Composable
fun rememberDefaultDrawerState() = rememberDrawerState(
    initialValue = if (isCloseableNavigationDrawer()) DrawerValue.Closed else DrawerValue.Open
)
